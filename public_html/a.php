    ...
    <head>
        ...
        <script>
            ...
            function getArticlesInfo(myIds) {
                ...
                if (str.length == 0) { 
                    ...
                    xmlhttp.onreadystatechange = function() {
                        ...
                        button1.addEventListener("click", function(){likeArticle()});
                        var button2 = document.createElement("BUTTON");
                        button2.innerHTML = "Dislike";
                        button2.addEventListener("click", function(){dislikeArticle()});
                        box.type = "text";
                        box.setAttribute("id","like");
                        var box2 = document.createElement("input");
                        box2.type = "text";
                        box2.setAttribute("id","dislike");
 					    document.getElementById('links').appendChild(box);
                        document.getElementById('links').appendChild(button1);
                        
                        document.getElementById('links').appendChild(box2);
                        document.getElementById('links').appendChild(button2);
            ...
            function likeArticle(){
                id = document.getElementById("like").value;       
            	str = document.getElementById("searchDisease").value;
                str = str.replace(/\s/g, '');
                if (str.length == 0) { 
                    document.write('');
                    ...
                    var xmlhttp = new XMLHttpRequest(),
                    method = "GET",
                    url = "/~aw003/rest/articleFeedBackPos/" + str + "/" + id + "/";
                    xmlhttp.open(method, url, true);
                    xmlhttp.setRequestHeader('Accept', 'application/json');
            ...
            function dislikeArticle(){
                id = document.getElementById("dislike").value;      
                str = document.getElementById("searchDisease").value;
                str = str.replace(/\s/g, '');
                if (str.length == 0) { 
                    document.write('');
                    ...
                    var xmlhttp = new XMLHttpRequest(),
                    method = "GET",
                    url = "/~aw003/rest/articleFeedBackNeg/" + str + "/" + id + "/";
                    xmlhttp.open(method, url, true);
                    xmlhttp.setRequestHeader('Accept', 'application/json');
            ...
            <div >
                <form action = "a.php" method='get' autocomplete='off'>
                    ...
                    <ul class="list-group" id="result"></ul>
                     <button class="center button button2" onclick="myFunction()">Pesquisa Diseases</button>
                  
        
                </form>
            </div>
        </div>
         <button class="center button button2" onclick="myFunction()">ver resultados</button>
